...
import FormTranslation from "../app/components/FormNewTranslation"
    ...
    <div className='flex flex-1'>
     ...
     <div className='bg-gray-50 h-full flex flex-col grow pb-24'>
      <div className="flex flex-col m-auto px-32 mt-12 bg-gray-200 dark:border-gray-900 rounded-xl shadow-lg shadow-cyan-500/50 ">
        <h1 className="text-center dark:text-gray-900 text-4xl p-12 mb-2 font-extrabold">Cadastro da Tradução</h1>
        {/* Formulário da Tradução */}
        <ToastContainer />
        <FormTranslation />
      </div>
     </div>
